...
st.sidebar.markdown("- [📧 Gmail (AIカーリーズ)](https://mail.google.com/mail/u/0/)")
st.sidebar.markdown("- [📧 Gmail (きよた書店)](https://mail.google.com/mail/u/1/)")
st.sidebar.markdown("- [📧 Gmail (ホビーコレクト)](https://mail.google.com/mail/u/2/)")
st.sidebar.markdown("- [📧 Gmail (清隆)](https://mail.google.com/mail/u/3/)")
