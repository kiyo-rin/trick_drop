...
url = "https://www.books-yagi.co.jp/bb/books/search/search_criteria:yagi_parent_search/categorycd:92330/page:1/keyword:9784842107264"
driver.get(url)

html = driver.page_source
m = re.search(r'全(\d+)件', html)
if m: print("Count:", m.group(1))
