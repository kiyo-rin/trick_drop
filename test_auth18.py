...
url = "https://www.books-yagi.co.jp/bb/books/search/search_criteria:detail_search/isbn:9784767202389"
driver.get(url)
soup = bs4.BeautifulSoup(driver.page_source, "html.parser")
amount = soup.find('div', class_='amount')
print("Detail ISBN search via GET:", amount.text.strip() if amount else "None")
