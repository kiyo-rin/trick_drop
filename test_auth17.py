...
url = "https://www.books-yagi.co.jp/bb/books/search/search_criteria:keyword_search/page:1/keyword:9784767202389"
driver.get(url)
soup = bs4.BeautifulSoup(driver.page_source, "html.parser")
amount = soup.find('div', class_='amount')
print("ISBN default field search:", amount.text.strip() if amount else "None")
